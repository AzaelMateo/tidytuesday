...
prime <- sub1 %>% 
  ...
  labs(x = NULL, 
       ...
       subtitle = str_wrap("El gráfico superior muestra el porcentaje promedio de usuarios por edad que utilizan internet México: a los 17 años el 92% de los usuarios acceden a internet, 
       a partir de entonces el porcentaje comienza a reducirse. A los 60 años, el 35% de los usuarios utiliza el internet. El gráfico inferior ilustra el uso de internet por edad y entidad federativa en México.", 100)) +
  theme_tufte() +
...
# Export vis
ggsave("AM202102_internet_users.png", vis, width = 13, height = 12)
